...
Defines the Wayland frontend's input stack: XKB keymap compilation from compositor-provided fds, modifier state sync, evdev keycode translation and keysym dispatch, pointer/touch hotspot hit-testing, and runtime `libxkbcommon` linkage.
